...
Criação da store_api para aprender mais sobre API e TDD utilizando com MongoDB.
Projeto feito baseado nas aulas da DIO Python AI Backend Developer.

13/07/2024 - Beatriz Ambrosio
